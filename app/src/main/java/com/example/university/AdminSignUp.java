...
import com.example.university.databinding.ActivityAdminSignUpBinding;
...
public class AdminSignUp extends AdminDrawerActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        allocateActivityTitle("New Account");
    ...
    private void CreateAccount() {
        ...
        if (!(isLecturerAccount.isChecked() || isStudentAccount.isChecked())) {
            Toast.makeText(AdminSignUp.this, "Select the Account Type", Toast.LENGTH_SHORT).show();
            return;
        }
            ...
            RootRef.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    if (!(snapshot.child("Users").child(reg).exists())) {
                                            ...
                                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                ...
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    if (task.isSuccessful()) {
                                                        ...
                                                        new Includes().navigateTo(AdminSignUp.this, Admin.class);
                                                    }
                                                    else {
                                                        loadingBar.dismiss();
                                                        Toast.makeText(AdminSignUp.this, "Network Error: Please try again", Toast.LENGTH_SHORT).show();
                                                    }
                                                }
                                            });
                                }
                        ...
                        Toast.makeText(AdminSignUp.this, "The registration number already exists", Toast.LENGTH_SHORT).show();
                        loadingBar.dismiss();
                    }
                }
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Includes navigate = new Includes().navigateTo(AdminSignUp.this, MainActivity.class);
        finish();
    }
}
